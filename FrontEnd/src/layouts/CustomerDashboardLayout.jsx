...
const NAV_ITEMS = [
  { icon: "dashboard", label: "Bảng điều khiển", active: true, filled: true, link: "/user/dashboard" },
//   { icon: "school", label: "My Courses", active: false },
//   { icon: "favorite", label: "Wishlist", active: false },
  { icon: "key", label: "Thay đổi mật khẩu", active: false, link: "/user/change-password" },
  { icon: "settings", label: "Cài đặt tài khoản", active: false, link: "/user/account-settings" },
